...
export async function get(req,res,next){try{const x=await service.getByCountry(req.params.country);return x?ok(res,x):fail(res,'Market not found',404)}catch(e){next(e)}}
